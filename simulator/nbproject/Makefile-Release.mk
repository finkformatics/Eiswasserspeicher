...
LDLIBSOPTIONS=-lboost_system -lpthread -lwiringPi
...
${OBJECTDIR}/SNull.o: SNull.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SNull.o SNull.cpp
...
${OBJECTDIR}/TcpSession.o: TcpSession.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TcpSession.o TcpSession.cpp
