...
1. Beide Pumpen anschalten
2. Beide Pumpen ausschalten
3. Verlassen

Wenn beide Pumpen angeschaltet werden beginnt der Kühlvorgang, falls genug Eis vorhanden ist. Nachdem die Pumpen ausgeschalten wurden ändert der Simulator seine Strategie und lädt den Speicher wieder voll, falls er kann. 
...
### Pumpen
Über die Pumpen wird geregelt, ob sie an oder aus sind. Außerdem berechnen sie den jeweiligen Durchfluss.
...
3. 08:30 Uhr - Pumpen ausschalten
4. 12:00 Uhr - Speicher wird geladen
5. 16:00 Uhr - Laden stoppen, Speicher zu ungefähr 2/3 voll
6. 16:30 Uhr - Einschalten der Pumpen, Starten des Kühlvorgangs
7. 17:30 Uhr - Speicher ist leer
8. 19:00 Uhr - Pumpen ausschalten
